...
const CALCULATORS = [
  { id: 'dose', icon: Pill, label: { fr: 'Calculateur de doses', pt: 'Calculador de doses', en: 'Dose calculator' }, available: true },
  { id: 'ett', icon: Stethoscope, label: { fr: 'Calculateur ETT / Intubation', pt: 'Calculadora ETT / Intubação', en: 'ETT / Intubation Calculator' }, available: true },
  { id: 'mallampati', icon: Activity, label: { fr: 'Score de Mallampati', pt: 'Score de Mallampati', en: 'Mallampati score' }, available: false },
