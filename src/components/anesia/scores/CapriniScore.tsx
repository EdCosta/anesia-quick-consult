...
const LABELS: Record<string, string> = {
  age41to60: 'caprini_age_41_60',
  age61to74: 'caprini_age_61_74',
  ageOver75: 'caprini_age_75',
  minorSurgery: 'caprini_minor_surgery',
  majorSurgery: 'caprini_major_surgery',
  bmiOver25: 'caprini_bmi_25',
  swollenLegs: 'caprini_swollen_legs',
  varicoseVeins: 'caprini_varicose',
  pregnancy: 'caprini_pregnancy',
  oralContraceptives: 'caprini_oc',
  sepsis: 'caprini_sepsis',
  seriousLungDisease: 'caprini_lung',
  acuteMI: 'caprini_mi',
  chf: 'caprini_chf',
  medicalPatientBedRest: 'caprini_bed_rest_med',
  ibd: 'caprini_ibd',
  arthroscopy: 'caprini_arthroscopy',
  malignancy: 'caprini_malignancy',
  laparoscopy: 'caprini_laparoscopy',
  bedRestOver72h: 'caprini_bed_rest_72',
  immobilizingCast: 'caprini_cast',
  centralVenousAccess: 'caprini_cvc',
  historyDVTPE: 'caprini_dvt_pe',
  familyHistoryThrombosis: 'caprini_family_thromb',
  factorVLeiden: 'caprini_factor_v',
  prothrombinMutation: 'caprini_prothrombin',
  lupusAnticoagulant: 'caprini_lupus',
  heparinInducedThrombocytopenia: 'caprini_hit',
  stroke: 'caprini_stroke',
  elHipKneeFx: 'caprini_hip_knee',
  multipleTrauma: 'caprini_trauma',
  acuteSpinalCordInjury: 'caprini_spinal',
};
