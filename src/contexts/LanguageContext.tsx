...
const UI: Record<string, Record<Lang, string>> = {
  ...
  allergies_placeholder: { fr: 'Ex: pénicilline, latex...', pt: 'Ex: penicilina, latex...', en: 'E.g.: penicillin, latex...' },
  ...
  generate_recommendations: { fr: 'Générer recommandations', pt: 'Gerar recomendações', en: 'Generate recommendations' },
